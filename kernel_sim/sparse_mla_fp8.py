...
def sparse_mla_fp8(batch_size, num_heads, s_q, topk, dim, gpu_type):
    ...
    total_dequant_cycles = (fp8_to_half_cycles + half_to_fp32_cycles + 
                           fp32_to_bf16_cycles + bf16_mul_fp32_cycles)
    ...
    t_per_block = t_LKAD_per_block if t_LKAD_per_block > s_q * t_MMA_per_block else s_q * t_MMA_per_block
